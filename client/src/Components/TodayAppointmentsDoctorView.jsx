...
const TodayAppointmentsDoctorView = ({ doctorId }) => {
  ...
  useEffect(() => {
    ...
    const fetchAppointments = async () => {
      try {
        ...
        const todayAppointments = appointmentsWithPatientData.filter(appointment => appointment.date === todayISOString);
...
export default TodayAppointmentsDoctorView;
